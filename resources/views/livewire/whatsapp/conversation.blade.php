<div data-testid="conversation" class="flex flex-col h-[calc(100vh-7rem)]">
    ...
    <ul class="flex-1 overflow-y-auto space-y-2 mt-4" data-testid="messages">
    ...
    <form wire:submit="send" class="mt-4 flex gap-2 items-end" data-testid="send-form">
        <div class="flex-1">
