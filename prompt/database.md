...
Create a suggested database markdown file in DBML format, put it in the `@docs/database_schema.md` file. It should follow the requirements for the `@docs/user_stories.md` and `@docs/project_description.md`. Follow best practices and typical conventions for Laravel 13 databases.
